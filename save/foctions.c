...
void reset_map_chara(SDL_Renderer* renderer, character *js, character  *hero,  rect_struct map_rect[][14], new_texture * perso, new_texture * monstre,new_texture * game_over,new_texture * blood_item,new_texture * hero_life,new_texture * js_life)
{
