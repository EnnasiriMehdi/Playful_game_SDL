...
int main(int argc, char **argv)
{
    ...
    TTF_Font * font ;
    font = TTF_OpenFont("pixel.ttf", 20);
...
for(int map_x = 0; map_x < 24; map_x++)
    {
        for(int map_y = 0; map_y < 14; map_y++)
        {
            ...
            {
                /* améliorer en faisant une fonction transmettant la structure en parametre : failed */
            ...
            else if(alea_map == 1 && map_x != 2 && map_y != 12 && map_x != 22 && map_y != 1)
            {
                ...
                map_rect[map_x][map_y].rect.w=50;                   /* améliorer en faisant une fonction transmettant la structure en parametre : failed */
...

{
    if(my_hero.pa == 0 && my_hero.pm == 0)
    {
        ...
        for(int i = 0; i < js.pm ; i ++ )
        {
            ...
            if(res_monster_move_x != 0 || res_monster_move_y != 0 )
            {
                ...
                reset_map_chara(renderer, &js, &my_hero,map_rect, perso,monstre,&game_over,&blood,&life_hero,&life_js);
            }
        }
        if ((abs(( my_hero.pos.x /50) - (js.pos.x /50) )+abs( (my_hero.pos.y / 50) - (js.pos.y /50)) ) <= morsure.po && js.pa >= morsure.pa )
                {
    ...
    while(SDL_PollEvent(&event_fight))
    {
            ...
            case SDL_KEYDOWN:
                    ...
                    case SDLK_h:
                        ...
                        printf("vous avez appuyer sur h \n");
                        printf(" %d \n", my_hero.pdv);
                        my_hero.pdv += 50;
                        printf(" %d \n", my_hero.pdv);
                    ...
                    case SDLK_k:
                        ...
                        printf("vous avez appuyer sur k \n");
